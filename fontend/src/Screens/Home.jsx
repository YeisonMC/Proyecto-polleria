      ...
      <div className="ImageContent">
        <section className="ImageContent-section" id="itemSection-1">
          <div className="ImageContent-images">
            <img
              src="https://mipolloalabrasa.com/wp-content/uploads/2021/06/1-pollo-a-la-brasa.png"
              alt=""
            />
          </div>
          <div className="ImageContent-buttons">
            <a href="#itemSection-3">
              <FaChevronCircleLeft size={70} />
            </a>
            <a href="#itemSection-2">
              <FaChevronCircleRight size={70} />
            </a>
          </div>
        </section>
        <section className="ImageContent-section" id="itemSection-2">
          <div className="ImageContent-images">
            <img
              src="https://imgmedia.buenazo.pe/1200x660/buenazo/original/2023/07/14/64ac3e8c599470217672a906.jpg"
              alt=""
            />
          </div>
          <div className="ImageContent-buttons">
            <a href="#itemSection-1">
              <FaChevronCircleLeft size={70} />
            </a>
            <a href="#itemSection-3">
              <FaChevronCircleRight size={70} />
